...
function calcularValorTotal(valorUnitario, quantidade) {
    ...
    if (quantidade >= 10) { // verifica se a quantidade comprada é maior ou igual a 10
    ...
    } else if (quantidade >= 5) { // verifica se a quantidade comprada é maior ou igual a 5
    ...
    } else { // se a quantidade comprada for menor que 5, não há desconto
